...
public class CustomTask_optionset extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... strings) {
        try {
            String str;
            URL url = new URL("http://" + server_ip + ":" + server_port + "/" + "setoption");  // 어떤 서버에 요청할지(localhost 안됨.)
            Log.w("URL",url.toString());
            Log.w("String값들", strings[0] + " " + strings[1] + " " + strings[2]);
            ...
            sendMsg = "id="+strings[0]+"&target_id="+strings[1] + "&option="+strings[2]; // GET방식으로 작성해 POST로 보냄 ex) "id=admin&pwd=1234";
